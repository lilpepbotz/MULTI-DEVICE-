...
sock.sendMessage(from, { caption: listmn, location: { jpegThumbnail: fs.readFileSync('./worker/media/image/loc.jpg') }, buttons: but, footer: '©NIU-MD'})
}
break
break
case prefix+'gura':
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "©NIU-MD", log0, btn, thum)
}
...
if (isBan) return ads(mess.ban)
if (!isCreator) return ads(mess.owner)
if (!args.join(" ")) return ads(`Text mana?\n\nExample : ${prefix + command} Alwi Ganteng`)
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "©NIU-MD ", log0, btn, thum)
}
...
title:"Niu-Botz - By Alwi",
body:"©  Niu-Botz - By Alwi",
thumbnail: log0,
mediaType:2,
mediaUrl: "https://youtube.com/channel/UCW7iXlE7TgvJMIXQck4NYBQ",
sourceUrl: "https://youtube.com/channel/UCW7iXlE7TgvJMIXQck4NYBQ"
